...
$(function(){
    ...
    onBeforeLoad:function(param){
    	if(f!=''&&f=='sys'){
    		var fm=new Date().format("yyyy-MM-dd");
    		$("#bis_aqss_dqsj").datebox('setValue',fm);
    		param.bis_aqss_dqsj=fm;
    	 }
    },
...
//创建查询对象并查询
function search(){
	$('#bis_aqss_qy_name').combobox('setValue',$('#bis_aqss_qy_name').combobox('getText'));
