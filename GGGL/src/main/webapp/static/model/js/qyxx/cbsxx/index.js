...
//弹窗增加
function add(u) {
	openDialog("添加承包商信息",ctx+"/bis/cbsxx/create/","800px", "400px","");
}
...
function upd(){
	...
	openDialog("修改承包商信息",ctx+"/bis/cbsxx/update/"+row.id,"800px", "400px","");
...
function view(){
	...
	openDialogView("查看承包商信息",ctx+"/bis/cbsxx/view/"+row.ID,"800px", "400px","");
...
function fileexport(){
	...
	window.exdata=[
			   		{colval:'m1', coltext:'承包商名称'},
			   		{colval:'m2', coltext:'承包项目'},
			   		{colval:'m3', coltext:'作业内容'},
			   		{colval:'m4', coltext:'作业人数'},
			   		{colval:'m8', coltext:'承包商负责人'},
	...
	layer.open({
        ...
        maxmin: false, 
        shift: 1,
	    content: ctx+'/bis/cbsxx/colindex',
		btn: ['导出'],
