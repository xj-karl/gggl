...
$(function(){
    ...
    columns:[[    
        ...
        {field:'m16',title:'设备状况',sortable:false,width:80,align:'center'},
        {field:'department',title:'设备使用单位',sortable:false,width:80,align:'center'},
...
//弹窗增加
function add(u) {
	openDialog("添加生产设备信息",ctx+"/bis/scsb/create/","800px", "500px","");
}
...
function upd(){
	...
	openDialog("修改生产设备信息",ctx+"/bis/scsb/update/"+row.id,"800px", "500px","");
...
function view(){
	...
	openDialogView("查看生产设备信息",ctx+"/bis/scsb/view/"+row.id,"800px", "500px","");
