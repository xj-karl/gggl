...
$(function(){
    ...
    columns:[[    
              ...
              {field:'m2',title:'涉粉作业人数',sortable:true,width:50,align:'center'},
              {field:'m3',title:'涉粉单班作业人数',sortable:true,width:50,align:'center'},
              {field:'m4',title:'取缔',sortable:true,width:50,align:'center', 
              	formatter : function(value, row, index){
              		if(value=='1') return value='是';
              		if(value=='0') return value='否';
              	}
              },
              {field:'m5',title:'关闭',sortable:true,width:50,align:'center',
              	formatter : function(value, row, index){
              		if(value=='1') return value='是';
              		if(value=='0') return value='否';
              	}
              },
              {field:'m6',title:'有除尘器',sortable:true,width:50,align:'center',
              	formatter : function(value, row, index){
              		if(value=='1') return value='是';
              		if(value=='0') return value='否';
              	}
              },
              {field:'m7',title:'除尘器种类',sortable:true,width:50,align:'center'},    
              {field:'m8',title:'建立粉尘清扫制度',sortable:true,width:50,align:'center',
              	formatter : function(value, row, index){
              		if(value=='1') return value='是';
              		if(value=='0') return value='否';
              	}
              },
              {field:'m9',title:'安装监控',sortable:true,width:50,align:'center',
              	formatter : function(value, row, index){
              		if(value=='1') return value='是';
              		if(value=='0') return value='否';
              	}
              },
              {field:'m11',title:'通过验收',sortable:true,width:50,align:'center',
              	formatter : function(value, row, index){
              		if(value=='1') return value='是';
              		if(value=='0') return value='否';
              	}
              },
              {field:'m12',title:'除尘器数量',sortable:true,width:50,align:'center'  },
              {field:'m13',title:'是否涉爆',sortable:true,width:50,align:'center', 
                	formatter : function(value, row, index){
                		if(value=='1') return value='是';
                		if(value=='0') return value='否';
                	}
                },
                {field:'m14',title:'是否职业病危害',sortable:true,width:50,align:'center',
                	formatter : function(value, row, index){
                		if(value=='1') return value='是';
                		if(value=='0') return value='否';
                	}
