    ...
    function _ab(_ac) {
        ...
        for (var _b1 = 0; _b1 < aa.length; _b1++) {
            ...
            if (_b2 == "list") {
                ...
                $("<td></td>").append(ps).append("<span>条</span>").prepend("<span style='padding-left: 3px'>每页</span>").appendTo(tr);
            } else {
                if (_b2 == "sep") {
...
(function ($) {
    ...
    function _60c(_60d, _60e, _60f) {
        ...
        //此方法导致大批量数据时加载过慢，删除使浏览器自适应高度，不确定对其他datagrid是否有细微影响。
...
(function ($) {
    ...
    function _9eb(_9f1, _9f2, _9f3) {
        ...
        //自定义
        _9f4.find("div.combobox-item-selected").removeClass("combobox-item-selected").find(":checkbox").prop("checked",false);;
        var _9f5 = null;
        var vv = [], ss = [];
        for (var i = 0; i < _9f2.length; i++) {
            ...
            var s = v;
            //自定义
            opts.finder.getEl(_9f1, v).addClass("combobox-item-selected").find(":checkbox").prop("checked",true);
    ...
    var _a23 = {
        render: function (_a24, _a25, data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                //自定义
                if(opts.multiple&&(opts.multiple==true||opts.multiple=='true'))
                    dd.push('<lable><input type="checkbox" class="combobox-checkbox">');
