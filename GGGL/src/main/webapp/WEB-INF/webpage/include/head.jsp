...
<script src="${ctxStatic}/common/jeecom.js?v=1.0.0" type="text/javascript"></script>
...
<!-- 引入easyui插件 -->
<link rel="stylesheet" type="text/css" href="${ctxStatic}/jquery-easyui-1.4.5/themes/metro/easyui.css">
...
<script src="${ctxStatic}/jquery-easyui-1.4.5/easyui.extensions.js"></script>
