...
<head>
    ...
    <title>智慧安监与事故应急辅助决策系统</title>

	<%@ include file="/WEB-INF/webpage/include/acehead.jsp"%>
...
<body class="no-skin">
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								<li>
									<a class="J_menuItem" href="${ctx}/system/user/updatePwd">
								...
								<li>
									<a class="J_menuItem" href="${ctx}/a/logout" target="_top">
		...
		<div class="main-container" id="main-container">
			...
			<div class="J_mainContent"  id="content-main">
             <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="http://map.baidu.com/" frameborder="0" data-id="${ctx}/home" seamless></iframe>
            </div>
            </div>
