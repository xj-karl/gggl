...
<title></title>
	...
	<script  type="text/javascript" src="${ctx}/static/model/js/qyxx/tzsbxx/adminindex.js?v=2.0"></script>
</head>
<body>
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" class="form-inline" style="margin-bottom: 8px;" >
        		<input type="text" id="qy_name" name="qy_name" style="height: 30px;" class="easyui-combobox" data-options="editable:true ,valueField: 'text',textField: 'text',url:'${ctx}/bis/qyjbxx/idjson',prompt: '企业名称' "/>
				...
				data-options="editable:false ,prompt: '设备类型',valueField: 'id',textField: 'text',url:'${ctx}/tcode/dict/tzsblx' " />
				  <input type="text" id="bis_tzsb_cx_time1" name="time1" style="height:30px" class="easyui-combobox" data-options="width:200,prompt: '到期时间查询', panelHeight:'auto', editable:false,data: [
								       {value:'7',text:'一个星期'},
								       {value:'14',text:'两个星期'},
								       {value:'21',text:'三个星期'},
							           {value:'30',text:'一个月'},
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="pull-left">
			        	...
			        	<shiro:hasPermission name="bis:tzsbxx:statistics">
