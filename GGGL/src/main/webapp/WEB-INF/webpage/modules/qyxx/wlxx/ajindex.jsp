...
<html>
  ...
  <script type="text/javascript" src="${ctx}/static/model/js/qyxx/wlxx/ajindex.js?v=1.6"></script>
  </head>
...
<div id="bis_wlxx_tb" style="padding:5px;height:auto">
	...
	<div class="form-group">
    	...
    	<input type="text" id="ccfs" name="ccfs" class="easyui-combobox" style="height: 30px;" data-options="panelHeight:'auto' , editable:false,data: [
			...
			<input type="text" id="bis_zdjg" name="bis_zdjg" class="easyui-combobox" style="height: 30px;" data-options="panelHeight:'auto' , editable:false,data: [
				        {value:'1',text:'是'},
				        {value:'0',text:'否'} ] ,prompt: '重点监管'"/>
