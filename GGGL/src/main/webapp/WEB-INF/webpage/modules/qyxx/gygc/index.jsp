...
<title></title>
	...
	<script  type="text/javascript" src="${ctx}/static/model/js/qyxx/gygc/index.js?v=1.5"></script>
</head>
<body>
       ...
       <div class="row">
				<div class="col-sm-12">
					<div class="pull-left">
						...
						<shiro:hasPermission name="bis:gygc:exin">
							<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="openImportDialog('${ctx}/bis/gygc/exinjump','${ctx}/bis/gygc/exin','${ctx}/static/templates/公用工程信息导入模板.xls')" title="导入"><i class="fa fa-folder-open-o"></i> 导入</button>
						</shiro:hasPermission>
