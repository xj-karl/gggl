...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/qyxx/yjxx/ajindex.js?v=1.2"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="bis_yjxx_tb" style="padding:5px;height:auto">
	...
	<input type="text" id="bis_yjxx_cx_qyname" name="bis_yjxx_cx_qyname" class="easyui-combobox"  style="height: 30px;" data-options="editable:true ,valueField: 'text',textField: 'text',url:'${ctx}/bis/qyjbxx/idjson',prompt: '企业名称' "/>
