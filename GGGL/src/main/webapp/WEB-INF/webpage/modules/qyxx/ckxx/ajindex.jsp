...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/qyxx/ckxx/ajindex.js?v=1.7"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="bis_ckxx_tb" style="padding:5px;height:auto">
	...
	<div class="form-group">
		<input type="text" id="bis_ckxx_cx_qyname" name="bis_ckxx_cx_qyname" class="easyui-combobox"  style="height: 30px;" data-options="editable:true ,valueField: 'text',textField: 'text',url:'${ctx}/bis/qyjbxx/idjson',prompt: '企业名称' "/>
	...
	<div class="col-sm-12">
		<div class="pull-left">
        	...
        	<shiro:hasPermission name="bis:ckxx:statistics">
