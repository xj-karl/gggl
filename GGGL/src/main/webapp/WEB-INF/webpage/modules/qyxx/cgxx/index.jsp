...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/qyxx/cgxx/index.js?v=1.6"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="bis_cgxx_tb" style="padding:5px;height:auto">
	...
	<div class="col-sm-12">
		<div class="pull-left">
        	...
        	<shiro:hasPermission name="bis:cgxx:exin">
				<button class="btn btn-white btn-sm " data-toggle="tooltip" data-placement="left" onclick="openImportDialog('${ctx}/bis/cgxx/exinjump','${ctx}/bis/cgxx/exin','${ctx}/static/templates/储罐信息导入模板.xls')" title="导入"><i class="fa fa-folder-open-o"></i> 导入</button>
			</shiro:hasPermission>
