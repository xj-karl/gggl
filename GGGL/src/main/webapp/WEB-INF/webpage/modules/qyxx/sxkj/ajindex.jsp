...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/qyxx/sxkj/ajindex.js?v=1.2"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="bis_sxkj_tb" style="padding:5px;height:auto">
	...
	<input type="text" id="bis_sxkj_cx_qyname" name="bis_sxkj_cx_qyname" class="easyui-combobox"  style="height: 30px;" data-options="editable:true ,valueField: 'text',textField: 'text',url:'${ctx}/bis/qyjbxx/idjson',prompt: '企业名称' "/>
	...
	<input name="bis_sxkj_cx_m7" class="easyui-combobox" style="height: 30px;"
								data-options="prompt:'易导致事故类型',
								editable:false ,valueField: 'text',textField: 'text',url:'${ctx}/tcode/dict/sglx' " />
