...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/qyxx/fcxx/ajindex.js?v=1.2"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="bis_fcxx_tb" style="padding:5px;height:auto">
	...
	<input type="text" id="bis_fcxx_cx_qyname" name="bis_fcxx_cx_qyname" class="easyui-combobox"  style="height: 30px;" data-options="editable:true ,valueField: 'text',textField: 'text',url:'${ctx}/bis/qyjbxx/idjson',prompt: '企业名称' "/>
	...
	<div class="col-sm-12">
		<div class="pull-left">
        	...
        	<shiro:hasPermission name="bis:fcxx:exin">
				<button class="btn btn-white btn-sm " data-toggle="tooltip" data-placement="left" onclick="openImportDialog('${ctx}/bis/fcxx/exinjump','${ctx}/bis/fcxx/exin','${ctx}/static/templates/冶金信息导入模板.xls')" title="导入"><i class="fa fa-folder-open-o"></i> 导入</button>
			</shiro:hasPermission>
