...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/qyxx/occupillexam/index.js?v=1.3"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="bis_occupillexam_tb" style="padding:5px;height:auto">
	...
	<div class="col-sm-12">
		<div class="pull-left">
        	...
        	<shiro:hasPermission name="bis:occupillexam:exin">
				<button class="btn btn-white btn-sm " data-toggle="tooltip" data-placement="left" onclick="openImportDialog('${ctx}/bis/occupillexam/exinjump','${ctx}/bis/occupillexam/exin','${ctx}/static/templates/职业病体检导入模板 .xls')" title="导入"><i class="fa fa-folder-open-o"></i> 导入</button>
			</shiro:hasPermission>
