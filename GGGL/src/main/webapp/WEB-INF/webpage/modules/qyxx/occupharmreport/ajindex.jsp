...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/qyxx/occupharmreportreport/ajindex.js?v=1.5"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="bis_occupharmreport_tb" style="padding:5px;height:auto">
	...
	<div class="form-group">
		<input type="text" id="bis_zybjcbg_cx_qyname" name="bis_zybjcbg_cx_qyname" style="height: 30px;" class="easyui-combobox" data-options="editable:true ,valueField: 'text',textField: 'text',url:'${ctx}/bis/qyjbxx/idjson',prompt: '企业名称' "/>
