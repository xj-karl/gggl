package com.cczu.sys.comm.persistence;
...
import com.cczu.sys.comm.persistence.PropertyFilter.MatchType;
import com.cczu.sys.comm.utils.Reflections;
...
public class SimpleHibernateDao<T, PK extends Serializable> {
	 ...
	 * @param entity
	 */
	public void saveIn(final T entity) {
		System.out.println("保存新增的对象");
	 ...
	 * @param entity
	 */
	public void saveUp(final T entity) {
		System.out.println("保存修改的对象");
