...
public class BisFwqyxxDao extends BaseDao<BIS_FwqyxxEntity, Long> {
  ...
  public List<Map<String, Object>> dataGrid(Map<String, Object> mapData) {
    ...
    String sql =
        " SELECT top "
            ...
            + ordercont
            + ") AS RowNumber,a.* FROM bis_fwqyxx a "
  ...
  public int getTotalCount(Map<String, Object> mapData) {
    String content = content(mapData);
    String queryString =
        "select count(*) from bis_fwqyxx a "
            + " left join bis_enterprise b on a.id1=b.id "
            + " WHERE a.S3=0 and b.S3=0 "
            + content;
   ...
   **/
  public List<Map<String, Object>> getQyIdjson(Map<String, Object> map) {
    String sql =
        "SELECT id,m1 text FROM bis_fwqyxx bis WHERE S3=0 and M1 is not null ";
    List<Map<String, Object>> list = findBySql(sql, null, Map.class);
    return list;
  }
}
